...
class AnagramMatch:
    def __init__(self, anagram_match_row) -> None:
        ...
        self.total_length_to_highest_length_captured_ratio = float(anagram_match_row[10])  # type: float
        self.word_count_difference = int(anagram_match_row[11])  # type: int
        self.different_word_count_to_total_word_count_ratio = float(anagram_match_row[12])  # type: float
        self.english_words_to_total_word_count_ratio = float(anagram_match_row[13])  # type: float
        self.total_words = int(anagram_match_row[14])  # type: int
        self.attempted_approval = bool(anagram_match_row[15] == "True")  # type: bool
        self.rejected = bool(anagram_match_row[16] == "True")  # type: bool
        self.auto_rejected = bool(anagram_match_row[17] == "True")  # type: bool
        self.date_created = anagram_match_row[18]  # type: str
        self.date_retweeted = anagram_match_row[19]  # type: str
        self.date_unretweeted = anagram_match_row[20]  # type: str
        self.date_posted_tumblr = anagram_match_row[21]  # type: str
        self.date_rejected = anagram_match_row[22]  # type: str
